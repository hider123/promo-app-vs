...
const RechargeModal = ({ isOpen, onClose, onConfirm, appSettings }) => {
    // [核心修改] 移除所有备援价格，如果设定未载入则为 0
    const catPoolPrice = appSettings?.catPoolPrice || 0;
    const buyInRate = appSettings?.buyInRate || 7.5; // 汇率通常可以有一个较稳定的预设值
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="bg-white w-11/12 max-w-sm mx-auto rounded-lg shadow-xl z-10">
                 <div className="p-6">
                    <h3 className="text-xl font-semibold text-gray-800">购买猫池帐号</h3>
                    <p className="text-sm text-gray-500 mt-1">
                        请输入您希望购买的帐号数量。
                    </p>
                    <div className="mt-6">
                        <label htmlFor="recharge-quantity" className="block text-sm font-medium text-gray-700">购买数量</label>
                    ...
                    <div className="mt-4 text-center bg-gray-50 p-4 rounded-lg">
                        <p className="text-gray-600">总计需储值：</p>
